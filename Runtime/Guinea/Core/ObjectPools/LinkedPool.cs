...
namespace Guinea.Core.ObjectPools
{
    ...
    {
        public LinkedPool(Func<T> createFunc, Action<T> actionOnGet = null, bool collectionCheck = true, int maxSize = 10000) : base(createFunc, actionOnGet, null, OnDestroyPoolObject, collectionCheck, maxSize){
